...
# 颁发证书
yes | sudo certbot certonly --standalone --email 1105470619@qq.com -d chat.chengff.com --agree-tos
...
private-key-file=/etc/letsencrypt/live/chat.chengff.com/privkey.pem

certificate-file=/etc/letsencrypt/live/chat.chengff.com/fullchain.pem
