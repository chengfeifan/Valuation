...
# 颁发证书
yes | sudo certbot certonly --standalone --email 1105470619@qq.com -d jtest.chengfeifan.com --agree-tos
...
private-key-file=/etc/letsencrypt/live/jtest.chengfeifan.com/privkey.pem

certificate-file=/etc/letsencrypt/live/jtest.chengfeifan.com/fullchain.pem
